...
package com.xiaoping.test01.view;
...
public class AbSlidingPlayView extends LinearLayout {
	...
	private int pageLineHorizontalGravity = Gravity.CENTER_HORIZONTAL;
	...
	public void initView(Context context) {
		...
		//得到导航点的图片资源文件
		displayImage =getBitmapFormSrc(R.drawable.red_dot);
		hideImage =getBitmapFormSrc(R.drawable.gray_dot);
	 ...
	 * @return
	 */
	private Bitmap getBitmapFormSrc(int id){
		Bitmap bitmap=null;
